...
class ImageAugmenter:
    ...
    def flip(self):
        ...
        image_out_processed = tf.one_hot(image_out_processed, depth=255, dtype=tf.float32)
        image_out_processed = tf.reshape(image_out_processed, (self._width, self._height, 255))
